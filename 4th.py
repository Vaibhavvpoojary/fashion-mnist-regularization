...
train_images, test_images = train_images[..., None] / 255.0, test_images[...,None] / 255.0   # Function to build and evaluate a model
def build_and_evaluate(name, regularizer=None,dropout_rate=None): 
  model = models.Sequential([
     layers.Conv2D(32, (3, 3), activation='relu', input_shape=(28, 28, 1),
     kernel_regularizer=regularizer), layers.MaxPooling2D((2, 2)),
